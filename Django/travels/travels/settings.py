...
SECRET_KEY = 'django-insecure-5_jz-j46lcwl#f#vn0kqo5r7ne!r$8p)e55hq@j#$pt+j)kxri'
...
MIDDLEWARE = [
    ...
    "django.middleware.common.CommonMiddleware",  # For handling CORS preflight requests
